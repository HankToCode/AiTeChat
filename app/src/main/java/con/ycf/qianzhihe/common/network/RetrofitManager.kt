...
import con.ycf.qianzhihe.app.api.new_http.ApiService
import con.ycf.qianzhihe.app.api.new_http.UrlConstant
import con.ycf.qianzhihe.common.network.exception.ErrorStatus
import con.ycf.qianzhihe.common.network.exception.NetStatusException
import con.ycf.qianzhihe.common.network.interceptor.NetworkInterceptor
import con.ycf.qianzhihe.common.utils.NetworkUtil
...
//                    .addQueryParameter("deviceModel", AppUtil.getMobileModel())
    ...
    private fun addCacheInterceptor(): Interceptor {
        return Interceptor { chain ->
            ...
            if (!NetworkUtil.isNetworkAvailable(DemoApplication.getInstance().applicationContext)) {
    ...
    private fun getOkHttpClient(): OkHttpClient {
        ...
        //设置 请求的缓存的大小跟位置
        val cacheFile = File(DemoApplication.getInstance().applicationContext.cacheDir, "cache")
