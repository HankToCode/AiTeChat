...
import con.zds.base.aes.AESCipher;
import con.zds.base.json.FastJsonUtil;
import con.zds.base.util.SystemUtil;
import con.ycf.qianzhihe.app.alipay.MyALipayUtils;
import con.ycf.qianzhihe.app.api.old_http.CommonApi;
import con.ycf.qianzhihe.app.share.ShareInfo;
import con.ycf.qianzhihe.app.share.ShareUtil;
...
public class BaseAndroidJs extends Object {
    ...
    public void appLogin() {
        CommonApi.cleanUserInfo();
        CommonApi.checkUserToLogin(mActivity);
    }
