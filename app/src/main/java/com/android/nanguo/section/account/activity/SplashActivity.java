...
import com.android.nanguo.app.api.old_data.AesInfo;
...
import com.android.nanguo.app.weight.CommonConfirmDialog;
import com.android.nanguo.common.interfaceOrImplement.OnResourceParseCallback;
import com.android.nanguo.section.account.viewmodels.SplashViewModel;
import com.android.nanguo.section.dialog.UserProtocolDialog;
...
//        initMedia();
        ...
        //2天前时间戳
        long day1 = System.currentTimeMillis() - 86400000 * 2;
        //删除2天前时间戳
...
//                ToastUtil.toast(msg);
                    ...
                    Observable.just("")
                            .map(str -> {
                                *//*long dayOut3Time = System.currentTimeMillis() - 86400000L;
                                ...
                                File filePath = new File("/data/data/com.android.nanguo/files/easemobDB");
    ...
    private void showCommonConfirmDialog() {
        ...
        mCommonConfirmDialog.setTitle("您需要同意本隐私协议才能继续使用南国时光");
