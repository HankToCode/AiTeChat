...
import com.android.nanguo.app.adapter.GroupSingleMemberMuteAdapter;
...
public class GroupMemberTotalActivity extends BaseInitActivity {
    ...
    public static void start(Context context, String emChatId, String groupId) {
        Intent intent = new Intent(context, GroupMemberTotalActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_group_member_total;
    }
