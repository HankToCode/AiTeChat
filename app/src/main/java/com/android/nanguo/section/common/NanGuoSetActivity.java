...
import com.android.nanguo.common.widget.LogoffDialog;
...
//            tv_m.setText(StringUtil.isEmpty(DataCleanManager.getTotalCacheSize(this)) ? "" : DataCleanManager.getTotalCacheSize(this));
    ...
    @OnClick({R.id.tv_reset_login, R.id.tv_reset_pay,R.id.tv_reset_black,R.id.tv_clear,R.id.tv_logout,R.id.tv_user_agreement,R.id.tv_register_agreement})
