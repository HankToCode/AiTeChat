...
import com.android.nanguo.app.db.UserDao;
...
public class MyModel {
    ...
    protected Map<MyModel.Key,Object> valueCache = new HashMap<MyModel.Key,Object>();
    ...
    public void setSettingMsgNotification(boolean paramBoolean) {
        ...
        valueCache.put(MyModel.Key.VibrateAndPlayToneOn, paramBoolean);
    }

    public boolean getSettingMsgNotification() {
        Object val = valueCache.get(MyModel.Key.VibrateAndPlayToneOn);

        if(val == null){
            val = PreferenceManager.getInstance().getSettingMsgNotification();
            valueCache.put(MyModel.Key.VibrateAndPlayToneOn, val);
        }
    ...
    public void setSettingMsgSound(boolean paramBoolean) {
        ...
        valueCache.put(MyModel.Key.PlayToneOn, paramBoolean);
    }

    public boolean getSettingMsgSound() {
        Object val = valueCache.get(MyModel.Key.PlayToneOn);

        if(val == null){
            val = PreferenceManager.getInstance().getSettingMsgSound();
            valueCache.put(MyModel.Key.PlayToneOn, val);
        }
    ...
    public void setSettingMsgVibrate(boolean paramBoolean) {
        ...
        valueCache.put(MyModel.Key.VibrateOn, paramBoolean);
    }

    public boolean getSettingMsgVibrate() {
        Object val = valueCache.get(MyModel.Key.VibrateOn);

        if(val == null){
            val = PreferenceManager.getInstance().getSettingMsgVibrate();
            valueCache.put(MyModel.Key.VibrateOn, val);
        }
    ...
    public void setSettingMsgSpeaker(boolean paramBoolean) {
        ...
        valueCache.put(MyModel.Key.SpakerOn, paramBoolean);
    }

    public boolean getSettingMsgSpeaker() {
        Object val = valueCache.get(MyModel.Key.SpakerOn);

        if(val == null){
            val = PreferenceManager.getInstance().getSettingMsgSpeaker();
            valueCache.put(MyModel.Key.SpakerOn, val);
        }
...
//        valueCache.put(Key.DisabledGroups, list);
    ...
    public List<String> getDisabledGroups(){
        Object val = valueCache.get(MyModel.Key.DisabledGroups);
...
//        valueCache.put(Key.DisabledIds, ids);
    ...
    public List<String> getDisabledIds(){
        Object val = valueCache.get(MyModel.Key.DisabledIds);
