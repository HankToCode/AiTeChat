...
public class RechargeWebViewActivity extends BaseInitActivity {
    ...
    public static void actionStart(Context context, String url) {
        Intent intent = new Intent(context, RechargeWebViewActivity.class);
...
//        String content = "<p><font color='red'>hello baidu!</font></p>";
        webview.loadData(url, "text/html", "UTF-8"); // 加载定义的代码，并设定编码格式和字符集。
