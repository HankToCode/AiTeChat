...
public class SpannableStringUtil {
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (textSize != -1) {
                mBuilder.setSpan(new TextAppearanceSpan(null, Typeface.NORMAL, textSize, null, null),start, end, flag);
                textSize = -1;
            }
            if (isStrikethrough) {
            ...
            /*if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(THZApplication.getInstance(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(THZApplication.getInstance(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(THZApplication.getInstance(), resourceId), start, end, flag);
                    resourceId = 0;
