...
import com.ycf.qianzhihe.common.manager.UserProfileManager;
...
import com.ycf.qianzhihe.section.chat.delegates.ChatRecallAdapterDelegate;
import com.ycf.qianzhihe.section.chat.delegates.ChatVideoCallAdapterDelegate;
import com.ycf.qianzhihe.section.chat.delegates.ChatVoiceCallAdapterDelegate;
import com.ycf.qianzhihe.section.conference.ConferenceInviteActivity;
...
//        callKitConfig.setAgoraAppId("15cb0d28b87b425ea613fc46f7c9f974");
        callKitConfig.setAgoraAppId("36eed38fb49f4f7e9f8c1c5d96f844d3");//千纸鹤声网appId
...
//                getRTCToken(url, callback);
    ...
    public boolean saveContactList(List<EaseUser> contactList) {
        return demoModel.saveContactList(contactList);
    }
